  ...
  <div class="wrap-list">
    <div class="wrap-group">
      ...
      <div class="row">
        ...
        <div class="col col-lg-4">
          <input type="text" name="address" value="{if isset($item.address)}{$item.address|escape:'html'}{/if}" id="input-address">
        </div>
      </div>
...
{ia_print_js files='_IA_URL_plugins/clients_on_map/js/admin/manage' order='3'}
